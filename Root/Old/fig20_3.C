...
void fig20_3() {
    ...
    const int MAX_CLUSTER_WIDTH1 = 2;
    const int CLUSTER_WINDOW1 =5;
    const double THRESHOLD1 = 0.000001; // MeV -> = 0 * (1000 * 3.6 keV)

    const int MAX_CLUSTER_WIDTH2 = 2;
    const int CLUSTER_WINDOW2 =5;
    const double THRESHOLD2 = 0.0216; // MeV -> = 6 * (1000 * 3.6 keV)

    const int MAX_CLUSTER_WIDTH3 = 2;
    const int CLUSTER_WINDOW3 =5;
    const double THRESHOLD3 = 0.0432; // MeV -> = 12 * (1000 * 3.6 keV)
    ...
    legend->AddEntry("h1","Geant4: threshold =  0.0 keV","l");
    legend->AddEntry("h2","Geant4: threshold = 21.6 keV","l");
    legend->AddEntry("h3","Geant4: threshold = 43.2 keV","l");
    legend->Draw();
