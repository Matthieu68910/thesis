...
void figure20_1() {
    ...
    legend->AddEntry("h1","Geant4 : largeur max. des cluster = 1","l");
    legend->AddEntry("h2","Geant4 : largeur max. des cluster = 2","l");
    legend->AddEntry("h3","Geant4 : largeur max. des cluster = 3","l");
    legend->Draw();
