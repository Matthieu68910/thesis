...
void figure4_4() {
    ...
    const int MAX_CLUSTER_WIDTH1 = 3;
    const int CLUSTER_WINDOW1 =5;
    const double THRESHOLD1 = 0.01086; // MeV -> = 3 * (1000 * 3.62 keV)

    const int MAX_CLUSTER_WIDTH2 = 3;
    const int CLUSTER_WINDOW2 =5;
    const double THRESHOLD2 = 0.0222; // MeV -> = 6 * (1000 * 3.62 keV)

    const int MAX_CLUSTER_WIDTH3 = 3;
    const int CLUSTER_WINDOW3 =5;
    const double THRESHOLD3 = 0.0444; // MeV -> = 12 * (1000 * 3.62 keV)
    ...
    legend->AddEntry("h1","Geant4: threshold 3 x mean noise","l");
    legend->AddEntry("h2","Geant4: threshold 6 x mean noise","l");
    legend->AddEntry("h3","Geant4: threshold 12 x mean noise","l");
    legend->Draw();
