...
void figure14_full() {
    ...
    Double_t x3[NBR_BINS] = {   0.69750,
                                ...
                                22.45403,
                                23.94750}; // in keV !!!
    Double_t y3[NBR_BINS] = {   5.304240E+01,
                                1.447108E+01,
                                3.758250E+00,
                                1.521740E+00,
                                1.005530E+00,
                                ...
                                6.302000E-01,
                                4.845400E-01};
    Double_t ex3[NBR_BINS] = {  4.7600E-02,
                                3.5791E-02,
                                1.2624E-02,
                                3.9674E-03,
                                5.4579E-04,
                                ...
                                4.0991E-03,
                                5.7941E-03};
    Double_t ey3[NBR_BINS] = {  4.7600E-02,
                                3.5791E-02,
                                1.2624E-02,
                                3.9674E-03,
                                5.4579E-04,
    ...
    Double_t x4[NBR_BINS] = {   0.70200,
                                ...
                                22.44960,
                                23.96933}; // in keV !!!
    Double_t y4[NBR_BINS] = {   5.27400E+01,
                                1.45488E+01,
                                3.82115E+00,
                                1.53091E+00,
                                1.01646E+00,
                                ...
                                6.42580E-01,
                                4.92550E-01};
    Double_t ex4[NBR_BINS] = {  4.1274E-02,
                                3.3467E-02,
                                1.1268E-02,
                                8.7958E-03,
                                8.0305E-04,
                                ...
                                3.4065E-03,
                                3.0877E-03};
    Double_t ey4[NBR_BINS] = {  4.1274E-02,
                                3.3467E-02,
                                1.1268E-02,
                                8.7958E-03,
                                8.0305E-04,
    ...
    for (int j = 0; j < NBR_BINS; ++j)
    {
	    ...
	    for (int k = 0; k < ENTRIES; k++)
	    {
	        ...
	        nbr_hitsA.at(loop_number) += (double) res_A1.at(5) / (ENTRIES / 25);

	        nbr_hitsB.at(loop_number) += (double) res_B2.at(5) / (ENTRIES / 25);
